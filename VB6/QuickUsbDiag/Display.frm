...
Private Sub ResetButton_Click()
   ...
   ' Open the device
   result1 = QuickUsbOpen(hDevice, devName)
   If (result1 = 0) Then
   ...
   result1 = QuickUsbSetResetState(hDevice, 1)
   Sleep (1000)
   result2 = QuickUsbSetResetState(hDevice, 0)
...
Function GetFirmwareVersionString() As String
   ...
   If majorVersion <> 0 Then
      GetFirmwareVersionString = majorVersion & "." & minorVersion & buildVersion
   Else
