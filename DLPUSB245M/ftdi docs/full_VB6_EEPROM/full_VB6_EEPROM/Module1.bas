...
Public Type FT_PROGRAM_DATA
    ...
    IsoOutA As Byte
    IsoOutB As Byte
    PullDownEnable5 As Byte
    SerNumEnable5 As Byte
    USBVersionEnable5 As Byte
    USBVersion5 As Integer
    AlsHighCurrent As Byte
    BlsHighCurrent As Byte
    IFAlsFifo As Byte
    IFAlsFifoTar As Byte
    IFAlsFastSer As Byte
    AlsVCP As Byte
    IFBlsFifo As Byte
    IFBlsFifoTar As Byte
    IFBlsFastSer As Byte
    BlsVCP As Byte
